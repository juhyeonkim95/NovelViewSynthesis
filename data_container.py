...
#     def __init__(self, model, data_container: DataLoader, need_mask = False, data_type ='default'):
...
#     'Generates data for Keras'
#
#     def __init__(self, model, data_container: DataLoader, afn, need_mask=True):
#         self.data_container = data_container
#
#         self.n_elevation = 3
#         self.n_azimuth = 18
